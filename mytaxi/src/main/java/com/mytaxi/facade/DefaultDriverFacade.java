...
/**
 * Implementation of DriverFacade Interface
 * 
 * @author jeraldfdo
 */
@Service
public class DefaultDriverFacade implements DriverFacade {
    ...
    @Override
    public DriverDto findByDriverId(Long driverId) throws EntityNotFoundException {
    ...
    @Override
    public List<DriverDto> findByOnlineStatus(OnlineStatus onlineStatus) {
    ...
    @Override
    public void deSelectCarByDriver(Long driverId, Long carId) throws CarAlreadyInUseException, EntityNotFoundException {
        Driver driver;
        Car car;
        try {
            driver = driverService.findByDriverId(driverId);
